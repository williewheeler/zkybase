/* 
 * MiddlewareStackTemplateController.java
 * 
 ...
 */
@Controller
@RequestMapping("/templates/middlewarestacks")
public class MiddlewareStackTemplateController extends AbstractController {
