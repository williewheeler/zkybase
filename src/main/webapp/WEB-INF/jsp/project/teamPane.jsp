...
<c:url var="membersUrl" value="/projects/${project.key}/members" />
					...
					<tr>
						...
						<td>
							<c:if test="${not empty member.workPhone}">
								Work: <c:out value="${member.workPhone}" /><br />
							</c:if>
							<c:if test="${not empty member.mobilePhone}">
								Mobile: <c:out value="${member.mobilePhone}" /><br />
							</c:if>
							<c:if test="${not empty member.email}">
								<a href="mailto:<c:out value="${member.email}" />"><c:out value="${member.email}" /></a><br />
							</c:if>
						</td>
					</tr>
				</c:forEach>
