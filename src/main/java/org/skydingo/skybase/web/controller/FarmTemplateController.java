 ...
 */
@Controller
public class FarmTemplateController extends AbstractController {
	...
	@RequestMapping(value = "/projects/{key}/farmtemplates", method = RequestMethod.POST)
	public String createFarmTemplate(@PathVariable String key, @ModelAttribute @Valid FarmTemplate farmTemplate) {
		Project project = projectRepo.findProjectByKey(key);
		farmTemplate.setProject(project);
		farmTemplateRepo.save(farmTemplate);
		return "FIXME";
	}
}
