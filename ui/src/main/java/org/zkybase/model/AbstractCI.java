...
public abstract class AbstractCI<T extends CI<T>> implements CI<T> {
	...
	/* (non-Javadoc)
	 * @see org.zkybase.model.Entity#getId()
	 */
	@Override
	@XmlAttribute
	...
	/* (non-Javadoc)
	 * @see org.zkybase.model.Entity#setId(java.lang.Long)
	 */
	@Override
	public void setId(Long id) { this.id = id; }
	
	/* (non-Javadoc)
	 * @see org.zkybase.model.CI#getDateCreated()
	 */
	@Override
	public Date getDateCreated() { return dateCreated; }
	
	/* (non-Javadoc)
	 * @see org.zkybase.model.CI#setDateCreated(java.util.Date)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.zkybase.model.CI#getDateModified()
	 */
	@Override
	public Date getDateModified() { return dateModified; }
	
	/* (non-Javadoc)
	 * @see org.zkybase.model.CI#setDateModified(java.util.Date)
	 */
	@Override
