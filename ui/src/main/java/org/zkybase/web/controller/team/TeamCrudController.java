 ...
 */
package org.zkybase.web.controller.team;
...
public class TeamCrudController extends AbstractCrudController<Team> {
	private static final String[] ALLOWED_FIELDS = new String[] { "name" };
	
	@Inject private TeamService teamService;
	
	public CIService<Team> getService() { return teamService; }

	/* (non-Javadoc)
	 * @see org.zkybase.web.controller.AbstractEntityFormController#getAllowedFields()
	 */
	@Override
